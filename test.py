...
class MyWindow(QtWidgets.QWidget):
    def __init__(self, parent = None):
        ...
        self.model.setHeaderData(2, QtCore.Qt.Horizontal, 'Кол-во')
        ...
        hbox.addWidget(lblFilterCount2, alignment = QtCore.Qt.AlignRight)
        ...
        if count or count2:
            ...
            if count and not count2:
                ...
                if count == count2:
                    ...
                    s += "goodcount between " + str(count) + " and " + str(count2)
        self.model.setFilter(s)
        if self.chkDesc.isChecked():
            o = QtCore.Qt.DescendingOrder
        else:
            o = QtCore.Qt.AscendingOrder
